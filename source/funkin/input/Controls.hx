...
class Controls extends FlxActionSet
{
	...
	public function mobileControlsJustPressed(id:MobileInputID):Bool
	{
		...
		var bools:Array<Bool> = [false, false, false, false, false];
		...
		if (state != null)
		{
			...
			if (state.mobileControls != null)
                ...
                if (PauseSubState.touchy != null) 
			bools[4] = PauseSubState.touchy.buttonJustPressed(id);
	...
	public function mobileControlsJustReleased(id:MobileInputID):Bool
	{
		...
		if (state != null)
		{
			...
			if (state.mobileControls != null)
                ...
                if (PauseSubState.touchy != null) 
			bools[4] = PauseSubState.touchy.buttonJustReleased(id);
	...
	public function mobileControlsPressed(id:MobileInputID):Bool
	{
		...
		if (state != null)
		{
			...
			if (state.mobileControls != null)
                ...
                if (PauseSubState.touchy != null) 
			bools[4] = PauseSubState.touchy.buttonPressed(id);
	...
	public function mobileControlsReleased(id:MobileInputID):Bool
	{
		...
		if (state != null)
		{
			...
			if (state.mobileControls != null)
                ...
                if (PauseSubState.touchy != null) 
			bools[4] = PauseSubState.touchy.buttonReleased(id);
