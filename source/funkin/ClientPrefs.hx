		...
		return [
			...
			"storageType" => {
				...
				data: [
					...
					"options" => ["EXTERNAL_DATA", "EXTERNAL_OBB", "EXTERNAL_MEDIA", "EXTERNAL", "EXTERNAL_GLOBAL"]
				]
			},
			"ScreenSaver" => {
			...
			"hitboxType" => {
				...
				data: [
					"recommendsRestart" => true,
					"options" => ["No Gradient", "No Gradient (Old)", "Gradient", "Hidden"]
				]
			},
			"controlsAlpha" => {
				display: "controlsAlpha",
			...
			"etternaHUD" => {
				...
				data: [
					"recommendsRestart" => true,
					"options" => ["Default", "V Slice", "Advanced", "Kade"]
				]
			},
